 ...
 * This file demonstrates how to integrate Novarelay with a web frontend
 */

// For React/Vue/Angular applications
export class NovarelayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NovarelayClient(provider, contractAddress);
